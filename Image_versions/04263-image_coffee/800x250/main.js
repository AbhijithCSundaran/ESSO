...
function animate() {
  ...
  // tl.set(object, { y: randomX(1), rotation: randomAngle(-1)});

  tl.to(human, 4, { y: -30, ease: Power2.easeOut, });
  tl.to(human, 4, { x: 0, ease: Power4.easeOut, }, "-=4");
  // tl.to(carShadow, 4, { y: -20, ease: Power2.easeOut,}, "-=4");
  tl.to(groundShadow, 4, { y: -10, x: 15, ease: Power2.easeOut, }, "-=4");
